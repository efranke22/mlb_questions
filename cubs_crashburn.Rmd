...
pitch_21_totals %>%
  ...
  labs(x="", y="spin rate (rpm)", color = "", title = "<strong><span style='color:goldenrod2'>The MLB teams with the 5 best records</span></strong></b> since the All-Star break tend to have pitched", 
  ...
  annotate(geom="text",x=as.Date("2021-07-10"), y=2550,label= "Best records: \nYankees \nBrewers \nRays \nBraves \nDodgers", family = "mono", fontface="bold", cex = 3.3, color = "goldenrod2")+
